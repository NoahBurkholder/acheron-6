...
//								RenderTexture offBuffer;

								void OnPreCull () {   // Aquas issue with OnPreRender

//												offBuffer = RenderTexture.GetTemporary(cameraEffect.pixelWidth, cameraEffect.pixelHeight);
//												cameraEffect.targetTexture = offBuffer;
...
//
//								void OnPostRender() {
//												cameraEffect.targetTexture = null;
//												OnRenderImage1(offBuffer, null);
//												RenderTexture.ReleaseTemporary(offBuffer);
//								}
								...
								void OnRenderImage (RenderTexture source, RenderTexture destination) {
												...
												if (renderPass == 0) {
																rtBeauty = RenderTexture.GetTemporary (source.descriptor); // (source.width, source.height, 0, source.format);
												}
												...
												if (_depthOfField) {
																...
																if (Camera.current != sceneCamera) {
																				...
																				RenderTexture rtDB = RenderTexture.GetTemporary (rtDofDescriptor); // source.width / _depthOfFieldDownsampling, source.height / _depthOfFieldDownsampling, 0, rtFormat);
												...
												if (requiresLuminanceComputation) {
																...
																for (int k = 0; k < rtEACount; k++) {
																				...
																				rtEA [k] = RenderTexture.GetTemporary (rtLumDescriptor); // sizeEA, sizeEA, 0, rtFormat);
																				sizeEA /= 2;
																}
